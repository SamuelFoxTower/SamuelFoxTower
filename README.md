...
3. **Интернет-сервисы и магазины**
   - [Построение модели определения стоимости автомобиля]([ссылка на проект](https://github.com/SamuelFoxTower/Portfolio/tree/main/determining-cost-cars)) - Разработка системы рекомендации стоимости автомобиля на основе его описания.
